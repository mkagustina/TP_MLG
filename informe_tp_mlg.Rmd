...
```{r, fig.cap='Distribución de diabetes', fig.height=4, fig.width=4}
# Gráfico para var respuesta
ggplot(datos, aes(x = factor(diabetes, labels = c("No", "Sí")))) +
  geom_bar(fill = "aquamarine3", width = 0.7) +  
  labs(
    x = "Diabetes",
...
graf2 <- ggplot(datos, aes(x = obesidad, fill = factor(diabetes))) +
  ...
  labs(
    x = "Nivel de obesidad",
    y = "Proporción",
    caption = "Proporción de personas con diabetes según nivel de obesidad"
  ) +
...
graf3 <- ggplot(datos, aes(x = presion, fill = factor(diabetes))) +
  ...
  labs(
    x = "Presión",
    y = "Proporción",
    caption = "Proporción de personas con diabetes según presión"
  ) +
  theme_minimal(base_size = 9)
...
graf4 <- ggplot(datos, aes(x = dpf, fill = factor(diabetes))) +
  ...
  labs(
    x = "DPF",
    y = "Proporción",
    caption = "Proporción de personas con diabetes según DPF"
  ) +
  theme_minimal(base_size = 9)
...
graf5 <- ggplot(datos, aes(x = glucosa, fill = factor(diabetes))) +
  ...
  labs(
    x = "Nivel de glucosa",
    y = "Proporción",
    caption = "Proporción de personas con diabetes según nivel de glucosa"
  ) +
  theme_minimal(base_size = 9)
...
graf6 <- ggplot(datos, aes(x = embarazo, fill = factor(diabetes))) +
  ...
  labs(
    ...
    y = "Proporción",
    caption = "Proporción de personas con diabetes según cantidad de embarazos"
  ) +
  theme_minimal(base_size = 9)
...
graf7 <- ggplot(datos, aes(x = factor(diabetes, 
  ...
  labs(
    x = "Diabetes",
    y = "Edad",
    caption = "Distribución de la edad según presencia de diabetes"
  ) +
  theme_minimal(base_size = 9) +
